...
public class Editor extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    } else if (comando.equals("Puntos")) { modo = PUNTOS; }
    else if (comando.equals("Lineas")) { modo = LINEAS; }
    else if (comando.equals("Circulos")) { modo = CIRCULOS; }
    else { modo = RECTANGULOS; }
  }
