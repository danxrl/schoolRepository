...
<head>
    ...
    <title>Encriptar aleatorio</title>
</head>
    ...
    <div class="container">
        <div>
            ...
            <p class="text-justify">
                Sistema que recibe un archivo de texto (con extensión .txt) y lo encripta convirtiendolo a valores binarios, toma dos bits aleatoriamente y los encripta.
            </p>
            <hr>
