...
if($_POST['r'] == 'inventario-in' && !isset($_POST['crud'])): ?>
    <main role="main">
        <section class="content-form" id="cliente_form">
            <h2 class="sub-title">Ingresar material a almacen '<?php echo $_POST['almacen_id'] ?>'</h2>
            <form method="post">
...
elseif($_POST['r'] == 'inventario-in' && $_POST['crud'] == 'set') :
